...
```{r}
econ.data <- read.csv("http://tutorials.iq.harvard.edu/R/Rgraphics/dataSets/EconomistData.csv")
```
...
```{r}
p <- ggplot(econ.data, mapping = aes(x = CPI, y = HDI))
p + geom_point()
```
...
(p3 <- p2 +
     scale_color_manual(name = "",
                        values = c("Americas" = "#25A9DD",
                                   "Asia Pacific" = "#AFE5F8",
                                   "East EU Cemt Asia" = "#33988D",   
                                   "EU W. Europe" = "#22526c",
                                   "MENA" = "#EF4F37",
                                   "SSA" = "#7C250E")))
```
